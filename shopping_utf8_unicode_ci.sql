...
CREATE TABLE `computer_detail_table` (
  `id` int(11) NOT NULL,
  `computer_id` int(11) DEFAULT NULL,
  `detail_src` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `computer_images_table` (
  `id` int(11) NOT NULL,
  `computer_id` int(11) DEFAULT NULL,
  `detail_src` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `earphone_detail_table` (
  `id` int(11) NOT NULL,
  `earphone_id` int(11) DEFAULT NULL,
  `detail_src` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `earphone_images_table` (
  `id` int(11) NOT NULL,
  `earphone_id` int(11) DEFAULT NULL,
  `detail_src` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `flat_detail_table` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `flat_images_table` (
  `id` int(11) NOT NULL,
  `flat_id` int(11) DEFAULT NULL,
  `detail_src` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `household_detail_table` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `household_images_table` (
  `id` int(11) NOT NULL,
  `household_id` int(11) DEFAULT NULL,
  `detail_src` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `iphone_detail_table` (
  `id` int(11) NOT NULL,
  `iphone_id` int(11) DEFAULT NULL,
  `detail_src` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `iphone_images_table` (
  `id` int(11) NOT NULL,
  `iphone_id` int(11) DEFAULT NULL,
  `detail_src` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(10, './img/nav/iphone/10.webp', 'iphone 15', '5999.00'),
...
(1117, '13187502076', '华为手机', './img/main/iphone/1117.webp', '7899.00', 1);
...
CREATE TABLE `router_detail_table` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `router_images_table` (
  `id` int(11) NOT NULL,
  `router_id` int(11) DEFAULT NULL,
  `detail_src` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('13187502076', '123456', '哈哈哈哈', '云南省玉溪市红塔区云南民族大学'),
('18213708932', 'xasbyydyh.', 'xas', '云南'),
...
--
-- 表的索引 `carousel_images`
--
ALTER TABLE `carousel_images`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `computer_detail_table`
--
...
-- 表的索引 `computer_table`
--
ALTER TABLE `computer_table`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `earphone_detail_table`
--
ALTER TABLE `earphone_detail_table`
  ADD PRIMARY KEY (`id`),
  ADD KEY `earphone_id` (`earphone_id`);

--
-- 表的索引 `earphone_images_table`
--
...
-- 表的索引 `earphone_table`
--
ALTER TABLE `earphone_table`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `flat_detail_table`
--
...
--
-- 表的索引 `household_table`
--
ALTER TABLE `household_table`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `iphone_detail_table`
--
...
-- 表的索引 `iphone_table`
--
ALTER TABLE `iphone_table`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `nav_computer`
--
ALTER TABLE `nav_computer`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `nav_earphone`
--
ALTER TABLE `nav_earphone`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `nav_flat`
--
ALTER TABLE `nav_flat`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `nav_household`
--
ALTER TABLE `nav_household`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `nav_iphone`
--
ALTER TABLE `nav_iphone`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `nav_router`
--
ALTER TABLE `nav_router`
  ADD PRIMARY KEY (`id`);
...
--
-- 使用表AUTO_INCREMENT `computer_detail_table`
--
ALTER TABLE `computer_detail_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- 使用表AUTO_INCREMENT `computer_images_table`
--
ALTER TABLE `computer_images_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;

--
-- 使用表AUTO_INCREMENT `earphone_detail_table`
--
ALTER TABLE `earphone_detail_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- 使用表AUTO_INCREMENT `earphone_images_table`
--
ALTER TABLE `earphone_images_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- 使用表AUTO_INCREMENT `flat_detail_table`
--
ALTER TABLE `flat_detail_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- 使用表AUTO_INCREMENT `flat_images_table`
--
ALTER TABLE `flat_images_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- 使用表AUTO_INCREMENT `household_detail_table`
--
ALTER TABLE `household_detail_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- 使用表AUTO_INCREMENT `household_images_table`
--
ALTER TABLE `household_images_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- 使用表AUTO_INCREMENT `iphone_detail_table`
--
ALTER TABLE `iphone_detail_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- 使用表AUTO_INCREMENT `iphone_images_table`
--
ALTER TABLE `iphone_images_table`
...
--
-- 使用表AUTO_INCREMENT `router_detail_table`
--
ALTER TABLE `router_detail_table`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- 使用表AUTO_INCREMENT `router_images_table`
--
ALTER TABLE `router_images_table`
